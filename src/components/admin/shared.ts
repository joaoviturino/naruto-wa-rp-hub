...
export const SKILL_CLASSES = [
  ...
  { value: "katon", label: "Katon (Fogo)", desc: "Afinidade elemental de fogo — chamas, brasas e explosões." },
  { value: "suiton", label: "Suiton (Água)", desc: "Afinidade elemental de água — correntes, ondas e névoa." },
  { value: "fuuton", label: "Fuuton (Vento)", desc: "Afinidade elemental de vento — cortes, rajadas e pressão." },
  { value: "doton", label: "Doton (Terra)", desc: "Afinidade elemental de terra — pedra, solo e defesas." },
  { value: "raiton", label: "Raiton (Raio)", desc: "Afinidade elemental de raio — descargas e velocidade elétrica." },
